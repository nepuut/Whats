...
await XeonBotInc.sendMessage(from, {text: xeonlod[i], edit: key });
        ...
        if (autobio) {
            XeonBotInc.updateProfileStatus(`24/7 Online Bot By Ahmed Cheats Bot Owner ${ownername} For more  Hacks Search On Youtube Ahmed Cheats`).catch(_ => _)
        }
                    ...
                    XeonBotInc.sendMessage(i, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                ...
                                thumbnailUrl: 'https://ibb.co/HDkjx63',
...
`.trim()
            ...
            case 'buyprem':
            case 'premium': {
                let teks = `Hi ${pushname}\n Premium is Paid! \n Contact Ahmed Cheats For Premium Membership +923323001142! \n`
                await XeonBotInc.sendMessage(m.chat, {
                    text: teks,
                    contextInfo: {
                        externalAdReply: {
            ...
            case 'runtime':
                ...
                XeonBotInc.sendMessage(m.chat, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: `Yt Ahmed Cheats`,
                            body: `Love from Ahmed Cheats ❤️`,
                            thumbnailUrl: 'https://ibb.co/HDkjx63',
                            sourceUrl: global.link,
                            mediaType: 1,
                            renderLargerThumbnail: true
            ...
            case 'scriptbot':
                XeonBotInc.sendMessage(m.chat, {
                    text: `Asllam U Allikum`,
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: `If You Want Buy Script Of AhmedCheatsV6 Contact AhmedCheats +923323001142 ❤️`,
                            body: `Love You bro 😘`,
                            thumbnailUrl: 'https://ibb.co/HDkjx63',
                            sourceUrl: global.link,
                            mediaType: 1,
...
*Do not forget to Join My Channel*
> _https://chat.whatsapp.com/LKBYqFHAdkAIDIjWdBjey5_
